...
export const DefendingStats: FC<DefendingStatsProps> = ({ players }) => {
  ...
  const renderPlayerActions = (actions: PlayerActions | undefined) => {
    const actionTypes: DefendingActionType[] = [
      'tackles',
      'aerialDuels',
      'fouls',
      'interceptions',
        ...
        <Table>
          ...
          <TableHeader>
            ...
            <TableRow>
              ...
              <TableHead className='border-r'></TableHead>
              <TableHead className='border-r'></TableHead>
              <TableHead className='border-r text-center' title='Tackles Won'>
                TKs.W
              </TableHead>
              <TableHead className='border-r text-center' title='Tackles Lost'>
                Tks.L
              </TableHead>
              <TableHead className='border-r text-center' title='Attempted Duels'>
                ATD
              </TableHead>
              <TableHead className='border-r text-center' title='Successful Duels'>
                SUD
              </TableHead>
              <TableHead className='border-r text-center' title='Foul Won'>
                FW
              </TableHead>
              <TableHead className='border-r text-center' title='Foul Commited'>
                FC
              </TableHead>
              <TableHead className='border-r'></TableHead>
              <TableHead className='border-r'></TableHead>
