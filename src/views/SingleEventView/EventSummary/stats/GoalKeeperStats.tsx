        ...
        <Table>
          ...
          <TableHeader>
            <TableRow>
              ...
              <TableHead colSpan={2} className='border-r text-center'>Saves</TableHead>
            ...
            <TableRow>
              ...
              <TableHead className='border-r'></TableHead>
              <TableHead className='border-r'></TableHead>
              <TableHead className='border-r text-center' title='Total Shots Faced'>TSF</TableHead>
              <TableHead className='border-r text-center' title='Total Shots Saved'>TSS</TableHead>
              <TableHead className='border-r'></TableHead>
              <TableHead className='border-r'></TableHead>
              <TableHead className='border-r'></TableHead>
              <TableHead className='border-r'></TableHead>
