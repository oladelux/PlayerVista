    ...
    <>
      ...
      <div className='Change-password'>
        <div className='Change-password__card'>
          ...
          <div className='Change-password__card-content'>Enter new password and confirm password to reset your forgotten password.</div>
          <form className='Change-password__card-form'>
            ...
            <Button type='submit' className='Change-password__card-form-btn'>Reset Password</Button>
            <div className='Change-password__card-form-footer'>
              <Link className='Change-password__card-form-footer-link' to={routes.login}>Back to Login</Link>
            </div>
          </form>
        </div>
      </div>
