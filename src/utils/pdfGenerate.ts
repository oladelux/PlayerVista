...
async function loadPdfTemplate<K>(templateName: string, data: K): Promise<string> {
...
export async function renderHTML<K>(templateName: string, data: K) {
  return await loadPdfTemplate(templateName, {
    ...data,
  })
}
